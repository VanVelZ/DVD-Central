...
namespace ZJV.DVDCentral.UI
{
    public partial class Genres : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                items = (List<Genre>)Session["items"];
            }
        }
        private void Rebind()
        {
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int results = GenreManager.Insert(item);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int results = GenreManager.Update(item);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //delete it from the database
                int results = GenreManager.Delete(item.Id);
