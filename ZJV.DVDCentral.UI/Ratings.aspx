<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ratings.aspx.cs" Inherits="ZJV.DVDCentral.UI.Ratings" %>
    ...
    <div class="form-row m1-2 mt-2">
        ...
        <div class="control-label col-md-3">
            <asp:DropDownList ID="ddlExisting"
                              ...
                              AutoPostBack="true"
                              OnSelectedIndexChanged="ddlRating_SelectedIndexChanged">
            </asp:DropDownList>
        </div>
    </div>
    <div class="form-row m1-2 mt-2">
